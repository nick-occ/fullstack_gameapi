...
from models import NewGameForm, GameForm
from models import MakeMoveForm, MoveForm
from models import CancelForm
from models import UserGames,UserRankings
from models import GameHistoryForm, GameHistory
